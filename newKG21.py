...
gold_filter_train = build_subject_conditioned_dataset_from_gold_triples(dataset_train)
gold_filter_test = build_subject_conditioned_dataset_from_gold_triples(dataset_test)
